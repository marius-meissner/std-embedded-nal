...
#![cfg_attr(feature = "embedded-nal-async", feature(generic_associated_types))] // for implementing -async
#![cfg_attr(feature = "embedded-nal-async", feature(type_alias_impl_trait))] // as async blocks
                                                                             // don't provide types
